...
$metadata[getenv('SAMLIDP_URL') . '/saml2/idp/metadata.php'] = array (
  'metadata-set' => 'saml20-idp-remote',
  'entityid' => getenv('SAMLIDP_URL') . '/saml2/idp/metadata.php',
  'SingleSignOnService' =>
  array (
    0 =>
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
      'Location' => getenv('SAMLIDP_URL') . '/saml2/idp/SSOService.php',
    ),
  ),
  'SingleLogoutService' =>
  array (
    ...
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
      'Location' => getenv('SAMLIDP_URL') . '/saml2/idp/SingleLogoutService.php',
    ),
  ),
