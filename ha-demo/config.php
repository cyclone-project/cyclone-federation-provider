...
$config = array(
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'pgsql:host=' . getenv('POSTGRES_PORT_5432_TCP_ADDR') . ';port=' . getenv('POSTGRES_PORT_5432_TCP_PORT') . ';dbname=keycloak',

    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => getenv('POSTGRES_USER'),
